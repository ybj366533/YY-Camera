...
#define FFMPEG_CONFIGURATION "--disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-encoders --enable-encoder=png --enable-encoder=mjpeg --enable-encoder=h264_videotoolbox --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=hevc --disable-hwaccels --disable-muxers --enable-muxer=mp4 --enable-muxer=mjpeg --disable-demuxers --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=mov --enable-demuxer=mp3 --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=hevc --disable-bsfs --disable-bsf=chomp --disable-bsf=dca_core --disable-bsf=dump_extradata --disable-bsf=hevc_mp4toannexb --disable-bsf=imx_dump_header --disable-bsf=mov2textsub --disable-bsf=mp3_header_decompress --disable-bsf=mpeg4_unpack_bframes --disable-bsf=noise --disable-bsf=remove_extradata --disable-bsf=text2movsub --disable-bsf=vp9_superframe --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=concat --disable-protocol=crypto --disable-protocol=ffrtmpcrypt --disable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol=icecast --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=md5 --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --disable-protocol=rtmp --disable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=subfile --disable-protocol=unix --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-linux-perf --disable-bzlib --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --enable-debug --enable-small --prefix=/Users/naruto/workspace/00_GTVideo/IJKPlayer/ijkplayer-ios/ios/build/ffmpeg-arm64/output --cc='xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode' --extra-ldflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode '"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/naruto/workspace/00_GTVideo/IJKPlayer/ijkplayer-ios/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/naruto/workspace/00_GTVideo/IJKPlayer/ijkplayer-ios/ios/build/ffmpeg-arm64/output/share/ffmpeg"
