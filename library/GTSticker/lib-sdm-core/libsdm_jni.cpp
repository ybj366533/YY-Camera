...
#define JNI_CLASS_MGSTREAMER        "com/gtv/cloud/impl/tracker/GTVEffectTracker"
...
static int SDMTracker_loadModelJNI(JNIEnv *env, jobject thiz, jlong streamer_addr, jstring filename)
{
...
static void
SDMTracker_getGLESImageVertexJNI(JNIEnv *env, jobject thiz, jlong streamer_addr, jfloat centerX, jfloat centerY, jfloat angle, jfloat canvasWidth, jfloat canvasHeight, jfloatArray jout)
{
    SDM_TRACKER_WRAPPER * wrapper = (SDM_TRACKER_WRAPPER*)streamer_addr;
    ...
    wrapper->sdm_tracker->getGlesImageVertex((float)centerX, (float)centerY, (float)angle, (float)canvasWidth, (float)canvasHeight, out_data, 8);
...
static int
SDMTracker_trackImageJNI(JNIEnv *env, jobject thiz, jlong streamer_addr, jbyteArray jdata, jint size, jint width, jint height, jfloatArray jout)
{
    SDM_TRACKER_WRAPPER * wrapper = (SDM_TRACKER_WRAPPER*)streamer_addr;
...
static int
SDMTracker_trackImageAJNI(JNIEnv *env, jobject thiz, jlong streamer_addr, jbyteArray jdata, jint size, jint width, jint height, jint center_x, jint center_y, jfloat angle, jfloatArray jout)
{
    SDM_TRACKER_WRAPPER * wrapper = (SDM_TRACKER_WRAPPER*)streamer_addr;
    ...
    //    LOGE("SDMTracker_trackImageJNI trackImage bef ... \n");
    wrapper->sdm_tracker->trackImage(in_data, (int)size, (int)width, (int)height, (int)center_x, (int)center_y, (double)angle, out_data);
    //    LOGE("SDMTracker_trackImageJNI trackImage aft ... \n");
    if( in_data ) {
        (env)->ReleaseByteArrayElements(jdata, (jbyte*)in_data, 0);
    }
...
static int
SDMTracker_updateFaceRectJNI(JNIEnv *env, jobject thiz, jlong streamer_addr, jint x, jint y, jint width, jint height)
{
    SDM_TRACKER_WRAPPER * wrapper = (SDM_TRACKER_WRAPPER*)streamer_addr;
...
static void SDMTracker_startPlayStickerJNI(JNIEnv *env, jobject thiz, jlong streamer_addr, jstring foldername, jint loop)
{
    SDM_TRACKER_WRAPPER * wrapper = (SDM_TRACKER_WRAPPER*)streamer_addr;
...
static int SDMTracker_prepareTextureFramesJNI(JNIEnv *env, jobject thiz, jlong streamer_addr, jint count, jint ready)
{
    SDM_TRACKER_WRAPPER * wrapper = (SDM_TRACKER_WRAPPER*)streamer_addr;
...
static void SDMTracker_drawWithUniformJNI(JNIEnv *env, jobject thiz, jlong streamer_addr, jint unif, jint pos, jint coor)
{
    SDM_TRACKER_WRAPPER * wrapper = (SDM_TRACKER_WRAPPER*)streamer_addr;
...
static void SDMTracker_udpateCanvasSizeJNI(JNIEnv *env, jobject thiz, jlong streamer_addr, jint width, jint height)
{
    SDM_TRACKER_WRAPPER * wrapper = (SDM_TRACKER_WRAPPER*)streamer_addr;
