...
package com.ybj366533.camera.library;

import android.annotation.SuppressLint;
import android.opengl.GLES20;

import com.ybj366533.camera.library.util.TextureRotationUtil;
...
import static com.ybj366533.camera.library.GPUImageRenderer.CUBE;
import static com.ybj366533.camera.library.util.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    /*
     * (non-Javadoc)
     * @see com.ybj366533.camera.library.GPUImageFilter#onInit()
     */
    @Override
    public void onInit() {
        super.onInit();
    ...
    /*
     * (non-Javadoc)
     * @see com.ybj366533.camera.library.GPUImageFilter#onDestroy()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.ybj366533.camera.library.GPUImageFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.ybj366533.camera.library.GPUImageFilter#onDraw(int,
