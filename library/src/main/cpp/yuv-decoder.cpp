...
Java_com_ybj366533_camera_library_util_GPUImageNativeLibrary_YUVtoRBGA(JNIEnv *env,
                                                                                  jobject obj,
                                                                                  jbyteArray yuv420sp,
                                                                                  jint width,
                                                                                  jint height,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ybj366533_camera_library_util_GPUImageNativeLibrary_YUVtoARBG(JNIEnv *env,
                                                                                  jobject obj,
                                                                                  jbyteArray yuv420sp,
                                                                                  jint width,
                                                                                  jint height,
