...
public abstract class GTVInstaFilter extends GTVImageFilter {
    ...
    public GTVInstaFilter(String fragmentShader, int textures) {
        this(VERTEX_SHADER, fragmentShader, textures);
    }

    public GTVInstaFilter(String vertexShader, String fragmentShader, int textures) {
