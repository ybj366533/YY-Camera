...
public class GTVImageLookupFilter extends GTVImageTwoInputFilter {
    ...
    public GTVImageLookupFilter() {
        this(1.0f);
    }

    public GTVImageLookupFilter(final float intensity) {
        super(LOOKUP_FRAGMENT_SHADER);
        mIntensity = intensity;
    }

    public GTVImageLookupFilter(final float intensity, final String frag) {
        super(frag);
        mIntensity = intensity;
    }
