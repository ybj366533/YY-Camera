...
public class GTVImageFilter {
    ...
    public GTVImageFilter(final String vertexShader, final String fragmentShader) {
    ...
    public int onDrawFrame(final int textureId) {
        int error;
        //Log.e("testtest44", " GUPImageFilter " + mIntputWidth + " " + mIntputHeight + " " + mOutputWidth + " " + mOutputHeight);
