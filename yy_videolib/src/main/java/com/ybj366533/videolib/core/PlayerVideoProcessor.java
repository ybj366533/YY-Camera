...
public class PlayerVideoProcessor extends VideoObject implements BaseTexture.TextureListener {
    ...
    EditorViewRender gtvEditorViewRender;
    ...
    public PlayerVideoProcessor(GLSurfaceView glSurfaceView, EditorViewRender gtvEditorViewRender) {
