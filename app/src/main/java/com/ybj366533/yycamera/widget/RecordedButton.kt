...
class RecordedButton : View {
    ...
    private fun init() {
        ...
        colorGray = resources.getColor(R.color.color1)
        colorBlue = resources.getColor(R.color.color2)
     ...
     * @param splitList
     */
    fun setSplit(splitList: MutableList<Float>) {
