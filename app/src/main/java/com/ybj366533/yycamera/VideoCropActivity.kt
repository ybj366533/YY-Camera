...
class VideoCropActivity : AppCompatActivity() {
    ...
    //输出 裁切完的路径
    private val outputPath = Environment.getExternalStorageDirectory().toString() + File.separator + "GTVCache"
    ...
    internal inner class GetVideoFrameRunable(private val frameCount: Int//幀数
        ...
        override fun run() {
            ...
            if (mEditor != null) {
                //抽帧
                mEditor!!.extractVideoFrame(IGTVVideoEditor.ImageFormat.IMAGE_JPEG, outputPath, 0, mEditor!!.getDuration(), frameCount, infos)
