...
//        }
    : RecyclerView.Adapter<RecordSettingRecyclerAdapterST.ImageTextHolder>(), View.OnClickListener {
    ...
    var imageRes = intArrayOf(R.mipmap.record_speed, R.mipmap.record_countdown)
    var testStr = intArrayOf(R.string.record_speed, R.string.record_countdown)
    var settingName = arrayOf("speed", "countdown")
