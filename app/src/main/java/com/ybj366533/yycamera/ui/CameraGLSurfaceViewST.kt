...
class CameraGLSurfaceViewST @JvmOverloads constructor(internal var mContext: Context, attrs: AttributeSet? = null) : GLSurfaceView(mContext, attrs), GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    override fun onDrawFrame(gl: GL10) {
        ...
        var lastTextureId = grpFilter!!.onDrawFrame(mTextureID)

        if (onTextureListener != null) {
            lastTextureId = onTextureListener!!.onTextureAvailable(lastTextureId, videoWidth, videoHeigt, timestampNanos)
        }
