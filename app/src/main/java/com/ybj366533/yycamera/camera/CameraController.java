package com.ybj366533.yycamera.camera;
...
import com.ybj366533.yycamera.Application;
...
public class CameraController implements ICamera{
    ...
    public void onFocus(Point point, Camera.AutoFocusCallback callback) {
        ...
        //再次进行转换
        point.x= (int) (((float)point.x)/ Application.screenWidth*2000-1000);
        point.y= (int) (((float)point.y)/ Application.screenHeight*2000-1000);
