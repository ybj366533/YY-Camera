...
#include "gtv_mp4Remux.h"
#include "gtv_transcode.h"
...
#define JNI_CLASS_GTVMP4HELP     "com/gtv/cloud/impl/GTVMP4Help"
...
static int
GTVMP4Help_Mp4VideoClipsMerge(JNIEnv *env, jclass clazz, jobjectArray fileListArr, jstring outputFilePath, jstring outputFilePathRev, jstring tempFolder) {
    
	GTV_ERROR("GTVMP4Help_Mp4VideoClipsMerge ... \n");
    ...
    if( c_outputFilePath == NULL ) {
        GTV_ERROR("GTVMP4Help_Mp4VideoClipsMerge params check ng (path) ... \n");
        return -1;
    }
	...
	for ( int i = 0; i < len; ++i) {
		...
		//GTV_ERROR("GTVMP4Help_Mp4VideoClipsMerge params check ng (path %s ) ... qqqqqqq\n", c_fileList[i]);
	}
	...
	gtv_mp4_clips_merge(c_fileList, len, c_outputFilePath);
	
	//if( c_outputFilePathRev != NULL && c_tempFolder != NULL){
	//	gtv_mp4_video_reverse(c_outputFilePath, temp_file);		//todo
	//	gtv_mp4_audio_video_merge(c_outputFilePath, temp_file, c_outputFilePathRev);	
	//}
...
static int
GTVMP4Help_Mp4AudioVideoMerge(JNIEnv *env, jclass clazz, jstring audioFilePath, jstring videoFilePath, jstring outputFilePath) {
    
	GTV_ERROR("GTVMP4Help_Mp4AudioVideoMerge ... \n");
    ...
    if( c_videoFilePath == NULL ) {
        GTV_ERROR("GTVMP4Help_Mp4AudioVideoMerge params check ng (path) ... \n");
        return -1;
    }
	...
	gtv_mp4_audio_video_merge(c_audioFilePath, c_videoFilePath, c_outputFilePath);
...
static int
GTVMP4Help_MP4FileSetCover(JNIEnv *env, jclass thiz, jstring filenameFrom, jstring filenameTo, jstring filenameTag)
{
    ...
    if( c_file_name_from == NULL ) {
        GTV_ERROR("GTVMP4Help_MP4FileSetCover params check ng (filename) ... \n");
        return -1;
    }
...
static int
GTVMP4Help_Mp4VideoExtractFrame(JNIEnv *env, jclass clazz, jstring inFilePath, jstring outDirPath, jstring outFilePrefix, jint startTime, jint endTime,
jintArray dataTimeStamp, jint dataNum, jint imgFormat, jfloat scale) {
    
	GTV_ERROR("GTVMP4Help_Mp4VideoExtractFrame ... \n");
    ...
    if( c_inFilePath == NULL ) {
        GTV_ERROR("GTVMP4Help_Mp4VideoExtractFrame params check ng (path) ... \n");
        return -1;
    }
    ...
    if( c_dataTimeStamp == NULL ) {
        GTV_ERROR("GTVMP4Help_Mp4VideoExtractFrame out_data is null.\n");
        return -4;
    }
	...
	gtv_mp4_video_extract_frame(c_inFilePath, imgFormat, c_outDirPath, c_outFilePrefix, startTime, endTime, c_dataTimeStamp, dataNum, &out_data_num, scale);
...
static int
GTVMP4Help_AudioExtractWaveForm(JNIEnv *env, jclass clazz, jstring inFilePath, jint startTime, jint endTime, jfloatArray audioData, jint dataNum) {
    
	GTV_ERROR("GTVMP4Help_AudioExtractWaveForm ... \n");
    ...
    if( c_inFilePath == NULL ) {
        GTV_ERROR("GTVMP4Help_AudioExtractWaveForm params check ng (path) ... \n");
        return -1;
    }
	
	c_audioData = (float*)(env->GetFloatArrayElements(audioData, 0));
    if( c_audioData == NULL ) {
        GTV_ERROR("GTVMP4Help_AudioExtractWaveForm out_data is null.\n");
        return -4;
    }
...
static int
GTVMP4Help_ImgToWebp(JNIEnv *env, jclass clazz, jobjectArray fileListArr, jstring outputFilePath) {
    
	GTV_ERROR("GTVMP4Help_ImgToWebp ... \n");
    ...
    if( c_outputFilePath == NULL ) {
        GTV_ERROR("GTVMP4Help_ImgToWebp params check ng (path) ... \n");
        return -1;
    }
	...
	for ( int i = 0; i < len; ++i) {
		...
		//GTV_ERROR("GTVMP4Help_ImgToWebp params check ng (path %s ) ... \n", c_fileList[i]);
	}
...
static int
GTVMP4Help_MP4FileTranscodeByX264(JNIEnv *env, jclass thiz, jstring filenameFrom, jstring filenameTo, jint gopSize, jobject listener)
{
    const char * c_file_name_from = NULL;
	const char * c_file_name_to = NULL;
    int ret = 0;
    ...
    if( c_file_name_from == NULL ) {
        GTV_ERROR("GTVMP4Help_MP4FileTranscodeByX264 params check ng (filename) ... \n");
        return -1;
    }
...
// video transcode
static int
GTVMP4Help_MP4FileImportVideoByX264_video(JNIEnv *env, jclass thiz, jstring filenameFrom, jstring filenameTo, jint gopSize, jobject listener, jint width, jint height, jint crop_flag, jint start_time, jint end_time)
{
    const char * c_file_name_from = NULL;
	const char * c_file_name_to = NULL;
    int ret = 0;
    ...
    if( c_file_name_from == NULL ) {
        GTV_ERROR("GTVMP4Help_MP4FileImportVideoByX264 params check ng (filename) ... \n");
        return -1;
    }
...
static int
GTVMP4Help_MP4FileImportVideoByX264_audio(JNIEnv *env, jclass thiz, jstring filenameFrom, jstring filenameTo, jint crop_flag, jint start_time, jint end_time)
{
    const char * c_file_name_from = NULL;
	const char * c_file_name_to = NULL;
    int ret = 0;
    ...
    if( c_file_name_from == NULL ) {
        GTV_ERROR("GTVMP4Help_MP4FileImportVideoByX264_audio params check ng (filename) ... \n");
        return -1;
    }
...
static int
GTVMP4Help_GetVideoInfo(JNIEnv *env, jclass clazz, jstring inFilePath, jintArray duration, jintArray video_size) {
    
	GTV_ERROR("GTVMP4Help_GetVideoInfo ... \n");
    ...
    if( c_inFilePath == NULL ) {
        GTV_ERROR("GTVMP4Help_GetVideoInfo params check ng (path) ... \n");
        return -1;
    }
	
	c_duration = (int*)(env->GetIntArrayElements(duration, 0));
    if( c_duration == NULL ) {
        GTV_ERROR("GTVMP4Help_GetVideoInfo out_data is null.\n");
        return -4;
    }
	...
	gtv_mp4_video_get_info(c_inFilePath, c_duration, c_duration+1, &width, &height);
...
static JNINativeMethod g_methods[] = {
    { "_Mp4VideoClipsMerge",					"([Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I",      		(int *) GTVMP4Help_Mp4VideoClipsMerge },
	{ "_Mp4AudioVideoMerge",					"(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I",      		(int *) GTVMP4Help_Mp4AudioVideoMerge },
	{"_MP4FileSetCoverJNI", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", (void*)GTVMP4Help_MP4FileSetCover},
	{"_Mp4VideoExtractFrame", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II[IIIF)I", (int*)GTVMP4Help_Mp4VideoExtractFrame},
	{"_AudioExtractWaveForm", "(Ljava/lang/String;II[FI)I", (int*)GTVMP4Help_AudioExtractWaveForm},
	{ "_ImgToWebp",					"([Ljava/lang/String;Ljava/lang/String;)I",      		(int *) GTVMP4Help_ImgToWebp },
	{"_MP4FileTranscodeByX264", "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)I", (int*)GTVMP4Help_MP4FileTranscodeByX264},
	{"_MP4FileImportVideoByX264_video", "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;IIIII)I", (int*)GTVMP4Help_MP4FileImportVideoByX264_video},
	{"_MP4FileImportVideoByX264_audio", "(Ljava/lang/String;Ljava/lang/String;III)I", (int*)GTVMP4Help_MP4FileImportVideoByX264_audio},
	{"_GetVideoInfo", "(Ljava/lang/String;[I[I)I", (int*)GTVMP4Help_GetVideoInfo}		
...
jint JNI_OnLoad_REMUXER(JavaVM *vm, void *reserved)
{
    ...
    // find class
    clazz = (env)->FindClass(JNI_CLASS_GTVMP4HELP);
    if (clazz == NULL)
    {
        GTV_ERROR("Native registration unable to find class '%s'", JNI_CLASS_GTVMP4HELP);
        return JNI_ERR;
    }
