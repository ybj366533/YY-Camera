 ...
 */
public class GTVEffectTracker {

    private static final String TAG = "GTVREC";

    private static boolean _libraryLoaded = false;

    private static List<GTVEffectTracker> _streamPool = new ArrayList<GTVEffectTracker>();
    ...
    public GTVEffectTracker() {

//        synchronized(GTVEffectTracker.class) {
//
//            if( _libraryLoaded == false ) {
//
//                try {
...
//        }
    ...
    ////////////////////////////////////////////////////////
    private static GTVEffectTracker _tracker_instance = null;
    public static GTVEffectTracker getInstance() {

        if( _tracker_instance == null ) {

            _tracker_instance = new GTVEffectTracker();
        }
