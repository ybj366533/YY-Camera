package com.gtv.cloud.impl.camera;
...
import com.gtv.cloud.impl.camera.utils.CameraUtils;
    ...
    public static void releaseCamera(Activity activity){
        ...
        synchronized (CameraEngine.class){
            ...
            try {
                ...
                LogUtils.LOGE("GTVREC", "releaseCamera err " + ex.getMessage());
            }
        }
...
//            }
    ...
    private static Size getPreviewSize(){
        ...
        LogUtils.LOGE("GTVREC", "error:try getPreviewSize but parameters is null. ");
    ...
    public static com.gtv.cloud.impl.camera.utils.CameraInfo getCameraInfo(){
        com.gtv.cloud.impl.camera.utils.CameraInfo info = new com.gtv.cloud.impl.camera.utils.CameraInfo();
    ...
    public static void focusOnTouch(float x, float y, int width, int height, final IGTVVideoRecorder.OnFocusListener listener) {
        synchronized (CameraEngine.class){
            if (camera == null) {
                return;
            }
            ...
            try{
                ...
                LogUtils.LOGE("GTVREC", "focusOnTouch err " + ex.getMessage());
            }
        }
