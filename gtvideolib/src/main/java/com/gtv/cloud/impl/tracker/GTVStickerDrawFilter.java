...
public class GTVStickerDrawFilter extends GTVImageFilter {

    private String newStickerFolder = null;
    private GTVStickerTextureLoader loader = null;

    public GTVStickerDrawFilter(EGLContext sharedContext) {
        super(NO_FILTER_VERTEX_SHADER, NO_FILTER_FRAGMENT_SHADER);
        loader = new GTVStickerTextureLoader(sharedContext);
    }
