...
public class GTVAnimationTextureLoader implements Runnable {
    ...
    private GTVEffectTracker mTracker = null;

    private EglCore mEglCore;
    private WindowSurface mInputWindowSurface;

    public GTVAnimationTextureLoader(EGLContext context, GTVEffectTracker tracker) {
...
Log.e("GTVANIM", "ordered loadSticker " + name);
    ...
    private static class StickerLoaderHandler extends Handler {
        ...
        private WeakReference<GTVAnimationTextureLoader> mWeakEncoder;

        public StickerLoaderHandler(GTVAnimationTextureLoader encoder) {
            mWeakEncoder = new WeakReference<GTVAnimationTextureLoader>(encoder);
        }
        ...
        public void handleMessage(Message inputMessage) {
            ...
            GTVAnimationTextureLoader encoder = mWeakEncoder.get();
            if (encoder == null) {
