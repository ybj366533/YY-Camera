...
public class GTVMP4Help {
    ...
    public static void extractAndScaleVideoFrameToJpg(String inFilePath, String outDirPath, int startTime, int endTime, int dataNum, ArrayList<GTVExtractFrameInfo> frameInfoList, float scale){
        ...
        for(int i = 0; i < num; ++i) {
            frameInfoList.add(new GTVExtractFrameInfo(outDirPath+outFilePrefix+"_"+i+".jpg", dataTimeStamp[i]));
        }

    }

    public static void extractVideoFrameToJpg(String inFilePath, String outDirPath, int startTime, int endTime, int dataNum, ArrayList<GTVExtractFrameInfo> frameInfoList){
        if (frameInfoList == null) {
            return;
        }
        frameInfoList.clear();
    ...
    public static void extractAndScaleVideoFrameToYuv(String inFilePath, String outDirPath, int startTime, int endTime, int dataNum, ArrayList<GTVExtractFrameInfo> frameInfoList, float scale){
        if (frameInfoList == null) {
            return;
        }
        frameInfoList.clear();
        ...
        for(int i = 0; i < num; ++i) {
            ...
            frameInfoList.add(new GTVExtractFrameInfo(outDirPath+outFilePrefix+"_"+i+".yuv", dataTimeStamp[i]));
        }

    }

    public static void extractVideoFrameToYuv(String inFilePath, String outDirPath, int startTime, int endTime, int dataNum, ArrayList<GTVExtractFrameInfo> frameInfoList){
        if (frameInfoList == null) {
            return;
        }
        frameInfoList.clear();
    ...
    public static void createWebpFromYuv(ArrayList<GTVExtractFrameInfo> frameInfoList, String outputFilePath) {
