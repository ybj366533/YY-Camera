...
public interface IGTVVideoRecorder2 {
    enum SpeedType{
        STANDARD,
        SLOW,
        FAST
    ...
    void init(String workFolder, RecordCallback recordCallback);
...
//    void stopPreview();
    ...
    // 写入视频帧
    int writeVideoFrame(int textureId, int textureWidth, int textureHeight, final boolean flip, long timestampNanos);
