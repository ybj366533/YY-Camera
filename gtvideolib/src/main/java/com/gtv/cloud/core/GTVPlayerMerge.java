...
public class GTVPlayerMerge {

    private static final String TAG = "GTVMerge";
    ...
    public GTVPlayerMerge(GLSurfaceView glSurfaceView, GTVEditorViewRender gtvEditorViewRender, String url) {
    ...
    public void startMerge(GTVPlayerVideoProcessor gtvPlayerVideoSource, GTVBaseTexture.TextureListener listener, PlayCallback playCallback) {
    ...
    protected void loopAudio() {
        ...
        while((running_flag == true) && (composeCancelFlag == false) ) {
            if (pause_flag == true) {
                ...
                {
                    this.gtvPlayerVideoProcessor.setDuration(gtVideoPlayer.currentTimestamp());
                    //检查时间设定filter
        ...
        try {
            ...
            gtMusicPlayer.setPlayerEventLisenter(new GTVideoPlayer.IGTVideoPlayerListener() {
                ...
                public void onPrepared(GTVideoPlayer p) {
                    ...
                    Log.e("app", "prepared");
                    musicPrepared = true;
                    gtMusicPlayer.seekTo((int)GTVPlayerMerge.this.startTimeMili);
                    gtMusicPlayer.setRange((int)GTVPlayerMerge.this.startTimeMili, gtMusicPlayer.getDuration()+1000);
                }
