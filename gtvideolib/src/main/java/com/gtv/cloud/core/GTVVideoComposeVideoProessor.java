...
public class GTVVideoComposeVideoProessor {
    ...
    //public GTVVideoComposeVideoProessor(GLSurfaceView glSurfaceView, GTVEditorViewRender gtvEditorViewRender) {
    public GTVVideoComposeVideoProessor(int imageWidth, int imageHeight) {
    ...
    //@Override
    public void videoProcess(int type, GTVBaseTexture obj) {
