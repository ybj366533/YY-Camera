...
import com.gtv.cloud.core.GTVPlayerVideoProcessor;
 ...
 */
public class GTVEditorViewRender extends GTVBaseRender implements IVideoTextureOutput {
    ...
    private GTVPlayerVideoProcessor gtvPlayerVideoProcessor;
    ...
    public GTVPlayerVideoProcessor getPlayerVideoObject() {
        return gtvPlayerVideoProcessor;
    }

    public GTVEditorViewRender(GLSurfaceView glSurfaceView, String videoPath) {

        super(glSurfaceView);

        this.videoPath = videoPath;

        gtvPlayerVideoProcessor = new GTVPlayerVideoProcessor(this.glSurfaceView, this);

        LogUtils.LOGE(TAG, "GTVEditorViewRender GTVEditorViewRender" + this.glSurfaceView.getWidth() + " " + this.glSurfaceView.getHeight());
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        LogUtils.LOGD(TAG, "GTVEditorViewRender onSurfaceCreated." + this.glSurfaceView.getWidth() + " " + this.glSurfaceView.getHeight());
    }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        LogUtils.LOGD(TAG, "GTVEditorViewRender onSurfaceChanged." + this.glSurfaceView.getWidth() + " " + this.glSurfaceView.getHeight());
    }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if( currentContext == null ) {
            ...
            LogUtils.LOGD(TAG, "GTVEditorViewRender currentContext setting");
        }
...
//    }
    ...
    public void onResume(){
        super.onResume();
        LogUtils.LOGD(TAG, "GTVEditorViewRender:onResume");
    ...
    public void onPause(){
        super.onPause();
        LogUtils.LOGD(TAG, "GTVEditorViewRender:onPause");
