...
import com.gtv.cloud.core.GTVCameraVideoProcessor;
 ...
 */
public class GTVRecorderViewRender extends GTVBaseRender implements IVideoTextureOutput {
    ...
    private GTVCameraVideoProcessor camInput;
    ...
    public GTVVideoObject getVideoResource() {
        return camInput;
    }

    public GTVRecorderViewRender(GLSurfaceView glSurfaceView, int cameraId, RecordCallback recordCallback) {

        super(glSurfaceView);
        this.recordCallback = recordCallback;
        camInput = new GTVCameraVideoProcessor(this.glSurfaceView, this, cameraId);
    ...
    public GTVCameraVideoProcessor getCameraVideoObject() {
        return camInput;
    }

    private GTVCameraVideoProcessor mCamera;

    @Override
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        super.onSurfaceCreated(gl, config);

        LogUtils.LOGD(TAG, "GTVRecorderViewRender onSurfaceCreated." + this.glSurfaceView.getWidth() + " " + this.glSurfaceView.getHeight());
    }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        LogUtils.LOGD(TAG, "GTVRecorderViewRender onSurfaceChanged." + " " + width + " " + height);
    }
...
//    }
    ...
    public void onPause() {
        super.onPause();
        LogUtils.LOGD(TAG, "GTVRecorderViewRender:onPause");
    ...
    public void focusOnTouch(float x, float y, IGTVVideoRecorder.OnFocusListener listener) {
