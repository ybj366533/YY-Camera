 ...
 */
//public abstract class GTVBaseRender extends GLSurfaceView implements GLSurfaceView.Renderer{
public abstract class GTVBaseRender implements GLSurfaceView.Renderer{
    /**
    ...
    //public GTVBaseRender(Context context) {
    //    this(context, null);
    //}

    //public GTVBaseRender(Context context, AttributeSet attrs) {
    public GTVBaseRender(GLSurfaceView glSurfaceView) {
        //super(context, attrs);
