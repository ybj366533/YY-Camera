...
/**
 * Created by gtv on 17/1/20.
 */

public class GTVVideoComposeStreamer implements IAudioEncoder.IADTCallback, IVideoEncoder.IAVCCallback {
    ...
    public GTVVideoComposeStreamer(String videoPath, AVStreamSetting setting, EGLContext context) {
    ...
    public GTVVideoComposeStreamer(String audioFilePath, String videoFilePath, AVStreamSetting setting, EGLContext context) {
